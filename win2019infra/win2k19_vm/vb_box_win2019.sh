...
VBoxManage storageattach $VM --storagectl "SATA Controller" --port 0 --device 0 --type dvddrive --medium /d/Users/User/Downloads/Windows-new/windows-server-2019/SERVER_EVAL_2019_x64FREE_en-us.ISO
