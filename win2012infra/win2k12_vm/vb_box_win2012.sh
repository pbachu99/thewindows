...
VBoxManage storageattach $VM --storagectl "SATA Controller" --port 0 --device 0 --type dvddrive --medium /d/Softwares/Windows-2012-OS-Server/Win2012_SE_SERVER_EVAL_EN-US-X64.ISO
...
# VBoxManage.exe list ostypes (OS Type, here --ostype "Windows2012_64")
