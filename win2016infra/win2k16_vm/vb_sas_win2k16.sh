...
# --ostype "Other_64" or --ostype Windows2016_64
# --ostype "WindowsNT_64"
...
VBoxManage storageattach $VM --storagectl "LSILogicSAS" --port 0 --device 0 --type dvddrive --medium /d/Users/User/Downloads/Windows-new/windows-server-2016/windr_2016_dc_EVAL_en-us.ISO
...
#
#VBoxManage storageattach $VM --storagectl "LSILogicSAS" --port 2 --device 0 --type hdd --medium sasd1.vmdk
#VBoxManage storageattach $VM --storagectl "LSILogicSAS" --port 3 --device 0 --type hdd --medium sasd2.vmdk
